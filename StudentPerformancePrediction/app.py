...
def load_and_train_models():
    ...
    try:
        df = pd.read_csv('student_performance_with_unique_names.csv')
    except FileNotFoundError:
        st.error("Error: 'student_performance_with_unique_names.csv' not found. Please place the file in the same directory.")
        st.stop()
    ...
    if 'Extracurricular Activities' in df.columns:
        ...
        st.error("Column 'Extracurricular Activities' not found in dataset.")
        st.stop()
